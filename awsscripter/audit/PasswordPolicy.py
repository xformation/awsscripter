...
class PasswordPolicy():
    ...
    def get_account_password_policy(self) -> object:
        ...
        """
        try:
            response = self.connection_manager.call(service="iam", command="get_account_password_policy",
                kwargs =None)
            ...
            if "cannot be found" in str(e):
                return False
            return False
        #     response = self.connection_manager.get.account_password_policy()
        #     return response['PasswordPolicy']
        # except  Exception as e:
        #     if "cannot be found" in str(e):
        #         return False
