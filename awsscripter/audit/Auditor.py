...
class Auditor(LambdaBase):
    ...
    def control_1_24_no_overly_permissive_policies(self):
        ...
        for m in pagedResult:
            policy = Audit.IAM_CLIENT.get_policy_version(PolicyArn=m['Arn'], VersionId=m['DefaultVersionId'])
            ...
            for o in n:
                try:
                    if o['CloudWatchLogsLogGroupArn']:
                        ...
                        client=self.connection_manager.call(
                            service='logs',
