...
class Control():
    ...
    def control_1_9_password_policy_length(self, passwordpolicy):
        ...
        if passwordpolicy is False:
            ...
            if passwordpolicy['MinimumPasswordLength'] < 14:
                result = False
                failReason = "Password policy  require at least 14 characters"
        return {'Result': result, 'failReason': failReason, 'Offenders': offenders, 'ScoredControl': scored,
                'Description': description, 'ControlId': control}
    ...
    def control_5_1_ensure_Dynamodb_SSE_enabled(self, regions):
        ...
        return {'Result': result, 'failReason': failReason, 'Offenders': offenders, 'ScoredControl': scored,
                'Description': description, 'ControlId': control}
# 5.2 Ensure rotation for customer created CMKs is enabled (Scored)
    def control_5_2_ensure_kms_cmk_rotation(self,regions):
        """Summary
