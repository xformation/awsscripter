...
from awsscripter.audit.cloud_trails import CloudTrail
from awsscripter.cli.pciaudit.controls import Control
...
class PciAuditor(LambdaBase):
    ...
    def handle(self, event, context):
        ...
        # control2.append(self.LM_2_2_cloudwatch_event_bus_centralized(self))
